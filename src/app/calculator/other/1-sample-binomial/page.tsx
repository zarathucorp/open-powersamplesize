...
export default function OneSampleBinomialPage() {
    ...
    const validate = () => {
        ...
        if (params.p === params.p0) {
            newErrors.p = "Proportion (p) and Comparison Proportion (p0) cannot be equal.";
            newErrors.p0 = "Proportion (p) and Comparison Proportion (p0) cannot be equal.";
        }
    ...
    return (
        <div className="space-y-8">
            ...
            <div>
                ...
                <DescriptionSection
                    title="Calculate Sample Size Needed to Other: 1-Sample Binomial"
