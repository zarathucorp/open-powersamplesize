...
test.describe('Calculator: Compare Paired Proportions (McNemar 2-Sided)', () => {
  test('should calculate the correct sample size and power', async ({ page }) => {
    // 1. 페이지로 이동합니다.
    await page.goto('/calculator/compare-paired-proportions/mcnemar-2-sided');
