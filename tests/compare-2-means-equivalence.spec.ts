...
test.describe('Calculator: Compare 2 Means (Equivalence)', () => {
  test('should calculate the correct sample size and power', async ({ page }) => {
    // 1. 페이지로 이동합니다.
    await page.goto('/calculator/compare-2-means/equivalence');
    ...
    await page.getByTestId('muB').fill('4');
