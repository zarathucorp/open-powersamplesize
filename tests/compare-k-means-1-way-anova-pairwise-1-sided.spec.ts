...
test.describe('Calculator: Compare K Means (1-Way ANOVA Pairwise 1-Sided)', () => {
  test('should calculate the correct sample size and power', async ({ page }) => {
    // 1. 페이지로 이동합니다.
    await page.goto('/calculator/compare-k-means/1-way-anova-pairwise-1-sided');
    ...
    await page.getByTestId('sampleSize').fill('85');
