...
test.describe('Calculator: Odds Ratio (Equivalence)', () => {
  test('should calculate the correct sample size and power', async ({ page }) => {
    // 1. 페이지로 이동합니다.
    await page.goto('/calculator/odds-ratio/equivalence');
    ...
    await page.getByTestId('pA').fill('0.25');
